...
blog = Blog()
postagem01 = Postagem(1, "Olá, pessoal!", "Lorem ipsum", datetime.now(),usuario)
blog.adicionarPostagem(postagem01)
postagem02 = Postagem(2, "Essa notícia só vai entrar amanhã", "Lorem lorem", datetime.now() + timedelta(days=1),usuario)
blog.adicionarPostagem(postagem02)
postagem03 = Postagem(3, "Essa notícia vai entrar daqui a pouco", "Lorem lorem", datetime.now() + timedelta(hours=1),usuario)
blog.adicionarPostagem(postagem03)
blog.publicarPostagem(postagem03)
postagem04 = Postagem(4, "Essa notícia vai entrar e será removida logo após", "Lorem lorem", datetime.now(),usuario)
